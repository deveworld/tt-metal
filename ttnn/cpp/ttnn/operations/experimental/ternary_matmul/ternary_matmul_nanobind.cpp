...
#include "ternary_matmul_nanobind.hpp"
...
namespace ttnn::operations::experimental::ternary_matmul::detail {

void bind_ternary_matmul(nb::module_& mod) {
    ttnn::bind_function<"ternary_matmul", "ttnn.experimental.">(
        mod,
        R"doc(
        ternary_matmul(input_tensor, weight_tensor, bias_tensor=None, *, fused_activation=None, config=None, memory_config=None, dtype=None, compute_kernel_config=None)
        ...
        config : Optional[TernaryMatmulConfig], default: None
        ...
        &ttnn::experimental::ternary_matmul,
        nb::arg("input_tensor"),
    ...
    auto py_ternary_matmul_config = nb::class_<TernaryMatmulConfig>(
                                        ...
                                        "TernaryMatmulConfig",
                                        R"doc(
                            Configuration for the TernaryMatmul operation.
                            )doc")
                                        .def(nb::init<>())
                                        .def(
    ...
    py_ternary_matmul_config.def_rw("M_block_size", &TernaryMatmulConfig::M_block_size, "");
    py_ternary_matmul_config.def_rw("K_block_size", &TernaryMatmulConfig::K_block_size, "");
    py_ternary_matmul_config.def_rw("N_block_size", &TernaryMatmulConfig::N_block_size, "");
    py_ternary_matmul_config.def_rw("subblock_h", &TernaryMatmulConfig::subblock_h, "");
    py_ternary_matmul_config.def_rw("subblock_w", &TernaryMatmulConfig::subblock_w, "");
    py_ternary_matmul_config.def_rw(
        "compute_with_storage_grid_size", &TernaryMatmulConfig::compute_with_storage_grid_size, "");

    py_ternary_matmul_config.def(
        "__repr__", [](const TernaryMatmulConfig& config) { return fmt::format("{}", config); });
}
